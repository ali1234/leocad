	...
	: QDialog(Parent), ui(new Ui::lcQImageDialog)
{
	...
	ui->width->setValidator(new QIntValidator(1, 8192, this));
	ui->height->setValidator(new QIntValidator(1, 8192, this));
...
void lcQImageDialog::accept()
{
	...
	{
		QMessageBox::information(this, tr("Error"), tr("Please enter a width between 1 and 8192."));
		return;
	}
	...
	{
		QMessageBox::information(this, tr("Error"), tr("Please enter a height between 1 and 8192."));
		return;
	}
